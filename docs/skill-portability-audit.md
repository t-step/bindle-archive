...
| U2 | A discovered Bindle skill is *invoked* by Codex and observably changes behavior | #57's acceptance criterion: one fixture-repo behavioral check per wave-1 skill |
