...
- `docs/workflow-composition.md` — provider-neutral classification and
  precedence contract (Invariants, Project instructions, Modes, Task
  workflows, Provider adapters) for what happens when more than one workflow
