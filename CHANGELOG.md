...
The versioned sections below are generated by
[Release Please](https://github.com/googleapis/release-please) from
Conventional Commit messages at release time — there is no hand-maintained
...
* **#179:** stable identities for project-map entries ([ae76f61](https://github.com/thomas-estep/bindle/commit/ae76f61632ed376544343ce067c8736f6410e195))
* **#180:** add check-context-graph-fixtures.py thin CLI adapter ([45996e9](https://github.com/thomas-estep/bindle/commit/45996e9d54ba5c862698de50fe536e42de6a0d8d))
* **#180:** add context_graph.canonical byte-exact candidate-key primitives ([334036c](https://github.com/thomas-estep/bindle/commit/334036c054d58a2aed93c47086070384619e86d9))
* **#180:** add context_graph.ids typed-ID parsing and formatting ([de18ea0](https://github.com/thomas-estep/bindle/commit/de18ea0e6ffc98c6262b88d5c65c4bee0b4fcc8b))
* **#180:** add context_graph.relationships vocabulary and endpoint matrix ([d001d6a](https://github.com/thomas-estep/bindle/commit/d001d6a95dc39d960de7e0a1600b283fefcf48ea))
* **#180:** add context_graph.validation object-kind and cross-object checks ([1343010](https://github.com/thomas-estep/bindle/commit/1343010ee9861ac60369567a2c56f94dc11992da))
* **#180:** add v1 context-graph JSON Schemas and invariant-coverage ledger ([6a73b25](https://github.com/thomas-estep/bindle/commit/6a73b250a8bba5124d7d4b49b780aed3039ddf1a))
* **#181:** normalize typed evidence references ([c6ad08e](https://github.com/thomas-estep/bindle/commit/c6ad08e8ce94f78c35b2bb375e3bf61ec6beb447))
* **#183:** implement the deterministic context-graph compiler ([dd58732](https://github.com/thomas-estep/bindle/commit/dd5873234fc566171620cdaf73a67b496c329a74))
* **#183:** implement the deterministic context-graph compiler ([dc16bdc](https://github.com/thomas-estep/bindle/commit/dc16bdcaa5f3966b117fae97aa30c5a831930046)), closes [#183](https://github.com/thomas-estep/bindle/issues/183)
* **#184:** add edge subject/dependency + anchor subject key primitives ([8e15cf0](https://github.com/thomas-estep/bindle/commit/8e15cf0c9b832fbbad6d0f6a9e97ab3da2a70a5b))
* **#184:** append-only judgments.jsonl persistence ([182454b](https://github.com/thomas-estep/bindle/commit/182454b97e9d57df622e2e467d92392becabedff))
* **#184:** candidates union — live anchor regen + ledger history ([6976555](https://github.com/thomas-estep/bindle/commit/69765555943e40e8a999029fd39cfa09ad1acbcc))
* **#184:** confirm — revalidate, allocate anchor id, append under lock ([208b8cc](https://github.com/thomas-estep/bindle/commit/208b8cc8676fae16669046e2617ceec8f9a7c9da))
* **#184:** propose orchestration over a fresh [#183](https://github.com/thomas-estep/bindle/issues/183) preview ([3fb40f6](https://github.com/thomas-estep/bindle/commit/3fb40f698b6c80d96a9f2889fdbf1debaccddb09))
* **#184:** reducer state machine — acceptance, suppression, retirement ([793058e](https://github.com/thomas-estep/bindle/commit/793058ea8edb4e4d6e2a6656c11fb80c0930dcfd))
* **#184:** validate edge proposals into candidates, legality before key ([b168798](https://github.com/thomas-estep/bindle/commit/b168798f054d38a02230f718c210052836929bf8))
* **#184:** wire propose/confirm/candidates CLI + capability ledger ([8b18c58](https://github.com/thomas-estep/bindle/commit/8b18c58de6efb581f94beecc7cc2dc6fab996287))
* **#185:** --adopt-context-md guard (still-markerless only) ([d928ea6](https://github.com/thomas-estep/bindle/commit/d928ea6bd28bb014c4984f37b9dcad8df983f39a))
* **#185:** apply writes atomically under lock with semantic no-op ([cde6272](https://github.com/thomas-estep/bindle/commit/cde6272d30fa40d7ab5617369de1232df8852f44))
* **#185:** apply.build_plan constructs and validates the full planned state ([47bf0b2](https://github.com/thomas-estep/bindle/commit/47bf0b279be56f3de48e52d1595c10b41a74a94b))
* **#185:** compile_preview accepts an in-memory map_text_override ([82b44ae](https://github.com/thomas-estep/bindle/commit/82b44ae52e9d165b6b09436bf881914922140e15))
* **#185:** config status reports orphaned temp files (never deletes) ([c4d35f1](https://github.com/thomas-estep/bindle/commit/c4d35f1db06ba25975496ab8b319ba920d37f2ab))
* **#185:** context.md lifecycle planner (create/update/noop/conflict) ([02bd6b8](https://github.com/thomas-estep/bindle/commit/02bd6b865bb29387313cdac289f5bbe9507584e1))
* **#185:** extend index.schema.json to the materialized-index shape ([9302167](https://github.com/thomas-estep/bindle/commit/9302167193b1b736c0122108f0fe869e654703ba))
* **#185:** index_writer renders the deterministic materialized index ([d1889cd](https://github.com/thomas-estep/bindle/commit/d1889cddbf49a9ae223f4dad915de18145d724cc))
* **#185:** map_writer inserts authorized anchor markers, minimal diff ([52448e0](https://github.com/thomas-estep/bindle/commit/52448e0b7eacade41d14ce3fb2559ed8dc41e491))
* **#185:** projection renders the deterministic context.md managed region ([1d4ef80](https://github.com/thomas-estep/bindle/commit/1d4ef8038327e805944acfdf4d8f45caa8a42765))
* **#185:** wire the apply subcommand into the CLI ([b02394d](https://github.com/thomas-estep/bindle/commit/b02394d1cdf491a838be422998e2143a7e504874))
* **#186:** optional context-graph authoring skill + ontology-safety graduation gate ([2a12161](https://github.com/thomas-estep/bindle/commit/2a121612f90c0d2f9edeaedd1f951ddfc31fea5b))
* **#191:** add CLI integration tests, notes-home docs, capability inventory ([a5424af](https://github.com/thomas-estep/bindle/commit/a5424af91eabe10c4280f8b49320882d2abeccd0))
* **#191:** add config break-lock CLI subcommand ([ac75447](https://github.com/thomas-estep/bindle/commit/ac75447bd259a5580389f82c1c8055d5dc95778b))
* **#191:** add config repository-binding CLI subcommands ([7ed0a41](https://github.com/thomas-estep/bindle/commit/7ed0a4175a8280b076412ac27ab5265ba52a1866))
* **#191:** add context-graph.py CLI with init and config status/validate ([ad893d3](https://github.com/thomas-estep/bindle/commit/ad893d323ebbbf28fcb7ce92f71cc706fbc0aabe))
* **#191:** add project identity allocation and init lifecycle ([3446a39](https://github.com/thomas-estep/bindle/commit/3446a39c1fdbeffbf5a4d20a0b8004365da9a517))
* **#191:** add repository binding CRUD ([f3b7474](https://github.com/thomas-estep/bindle/commit/f3b747450ab7bc5c7599b24b380ca1e086622e40))
* **#191:** add shared atomic-write primitives ([edb0e71](https://github.com/thomas-estep/bindle/commit/edb0e71989bf71cd9e10bf739fb91b8e71ed89c2))
* **#191:** add single-writer project lock ([40c33f2](https://github.com/thomas-estep/bindle/commit/40c33f2c2275abd2abd6bb91dd2a59ba68ba1a6b))
* **#191:** initialize context-graph project identity and repository bindings ([6155bfe](https://github.com/thomas-estep/bindle/commit/6155bfef708e79b3c36b90ccde22bac620e1cd64))
* **release:** add release-publish.sh to relabel autorelease PRs on manual publish ([d97cb90](https://github.com/thomas-estep/bindle/commit/d97cb902b5878351ba8b005519e495f5b7524dd9)), closes [#152](https://github.com/thomas-estep/bindle/issues/152)
* surface doctor findings at session start ([#192](https://github.com/thomas-estep/bindle/issues/192)) ([30d7d1a](https://github.com/thomas-estep/bindle/commit/30d7d1aa06ba2ea7fcc2f76477fc1b8de3ba1505))


### Bug Fixes

* **#179:** one retirement model — retirement moves the entry, never copies it ([8eaa247](https://github.com/thomas-estep/bindle/commit/8eaa2474333812a66ce12ef490fb5fb2625b2d1f))
* **#179:** reject bindle:superseded-by on active (non-tombstone) anchors ([6f4db65](https://github.com/thomas-estep/bindle/commit/6f4db65719deaf84a3cbe3e2543d1561e64e5484))
* **#179:** tighten duplicate-id detection to a strict retirement-pair invariant ([100ff1f](https://github.com/thomas-estep/bindle/commit/100ff1fc0e856863807637406939979648c3d893))
* **#180:** add missing schema_version to judgment fixtures, fix proposal shape, filter schema conformance to valid fixtures ([47a47be](https://github.com/thomas-estep/bindle/commit/47a47bee406db7274e3dc12e9c409a40c6f1cc75))
* **#180:** correct context-graph-schema.md proposals overclaim + maturity field ([9aae7ad](https://github.com/thomas-estep/bindle/commit/9aae7ad789dda25511fe80cbff177eff5c00bfaf))
* **#180:** correct remaining docstring overclaim in fixture CLI ([a3c82f7](https://github.com/thomas-estep/bindle/commit/a3c82f7efc2d3a48b9c953f175061565c6a4edd2))
* **#180:** drop redundant E_EDGE_SUPERSEDES_KIND_MISMATCH finding code ([55dd607](https://github.com/thomas-estep/bindle/commit/55dd607e21b2cc31f3e860d8cff6c7d16d65626f))
* **#180:** drop unused canonical import and correct CLI docstring claim ([fc5c8ea](https://github.com/thomas-estep/bindle/commit/fc5c8ea36e9bb5a1ef5ab7dc46ce6ac2d59a3091))
* **#183:** amend design_document evidence kind into document_repository/document_project_local ([d956934](https://github.com/thomas-estep/bindle/commit/d9569348a8e4066f505e2db9e9c8c5f2f1471c3e))
* **#184:** dedupe candidates by latest decision; canonicalize contradicts endpoints on candidate ([3056a15](https://github.com/thomas-estep/bindle/commit/3056a1506a2fd201bace9eb7d7182dddb67faa03))
* **#185:** disambiguate sibling anchor slots ([#184](https://github.com/thomas-estep/bindle/issues/184) key) and keep materialized anchors effective ([3be4a39](https://github.com/thomas-estep/bindle/commit/3be4a39f656c50ea904e0c443bce71acd1feb4af))
* **#185:** re-apply of a materialized anchor emits no spurious stale finding ([336fdce](https://github.com/thomas-estep/bindle/commit/336fdce3b741ef62e91e4b0a7d55dcb99afaf7cb))
* **#185:** two-tier illegal judged-edge handling (drop at reduction, abort in planned) ([0a382fc](https://github.com/thomas-estep/bindle/commit/0a382fc083d4c08b43896af981c37e20ddfe4ee6))
* **#185:** unconnected section ignores contains edges ([5e39f07](https://github.com/thomas-estep/bindle/commit/5e39f07e9ace95a9a727a61e2c779a34c29c72c8))
* **#191:** correct break-lock exception-handling claim in capability description ([5ffba72](https://github.com/thomas-estep/bindle/commit/5ffba72bed01760298d7de322f6e35f1b469160a))
* **#191:** decouple advisory local-origin checks from mutation gating; final review fixes ([cb0a8cb](https://github.com/thomas-estep/bindle/commit/cb0a8cbba9fa3aa15f5db9fabdeeda28ac188dd8))
* **#191:** guard lock acquisition write failure and add directory fsync ([32905ce](https://github.com/thomas-estep/bindle/commit/32905cedc7b26eee1d863c24921caf9386e49a55))
* **#191:** handle ConfigError in config status/validate, normalize finding shape ([2342103](https://github.com/thomas-estep/bindle/commit/23421037265aaec628df91e7cccff6bcf1d48e8f))
* **#191:** isolate git subprocess calls from ambient GIT_DIR environment ([fe022c2](https://github.com/thomas-estep/bindle/commit/fe022c260be5b5c41930f6f2a85406e009692ffe))
* **#191:** normalize finding-dict shape and reject malformed config shapes ([e60b31e](https://github.com/thomas-estep/bindle/commit/e60b31e0c9cebb421ec1034d88b31d73949ef896))
* **#191:** use scoped scratch dir for CLI test output, align docs formatting ([c74bb84](https://github.com/thomas-estep/bindle/commit/c74bb848cfb3355b13c7f2bbd7a756f999dedfa6))
* **#199:** document edge-subject endpoint fields on candidate.schema.json ([cb0ce7e](https://github.com/thomas-estep/bindle/commit/cb0ce7efcd22c8fdaa22f799dabfdae690718c92))
* **release-captain:** source the approval token from the operator, not self-minted ([#153](https://github.com/thomas-estep/bindle/issues/153)) ([3bb6b8d](https://github.com/thomas-estep/bindle/commit/3bb6b8d6b42a29e23a0ec5960ec5feabf26403cd))
* **release-captain:** source the approval token from the operator, not self-minted ([#153](https://github.com/thomas-estep/bindle/issues/153)) ([7bb1303](https://github.com/thomas-estep/bindle/commit/7bb1303754583658bfbd85cce0ccd53886c6f37d))
* **release:** chain release-please-sync into local-release-please apply ([8c6b000](https://github.com/thomas-estep/bindle/commit/8c6b00031bcf58d0886bfc2ed2034505ee9836d9)), closes [#152](https://github.com/thomas-estep/bindle/issues/152)
