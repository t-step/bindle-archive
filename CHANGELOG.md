...
- **#137:** split Release Please's checked-in version authority from post-tag
  publication provenance, require an annotated direct-tag gate and exact draft
  asset reuse/download verification, and retire the local release cutter.
